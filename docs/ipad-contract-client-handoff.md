...
2026-09-06 추가: 캐시 무효화·재시도·전송 차단의 최신 Windows 구현과
실사용 검증 결과는 [Windows 안정화 결과와 공통 동작 확인서](windows-handshake-stability-handoff-2026-09-06.md)를
함께 따른다. 아래의 iPad 현황과 당시 미해결 항목은 이 문서 작성 시점의 기록이며,
최신 iPad 구현 상태를 다시 확인한 결과가 아니다.
